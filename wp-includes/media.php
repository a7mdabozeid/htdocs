...
function wp_constrain_dimensions( $current_width, $current_height, $max_width = 0, $max_height = 0 ) {
	...
	if ( (int) round( (float)$current_width * (float)$larger_ratio ) > $max_width || (int) round( (float)$current_height * (float)$larger_ratio ) > $max_height ) {
	...
	$w = max( 1, (int) round( (float)$current_width * (float)$ratio ) );
	$h = max( 1, (int) round( (float)$current_height * (float)$ratio ) );
