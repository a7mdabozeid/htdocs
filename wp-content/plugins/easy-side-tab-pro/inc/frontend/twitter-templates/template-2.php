<div class="estp-tweets-wrapper estp-twitter-layout-2">
    ...
    <div class="estp-single-tweet-wrapper">
        <div class="estp-tweet-content">
            ...
            ?>
                ...
                <div class="estp-twitter-profile-name">
                    <h3><?php _e($tweet->user->name, ESTP_DOMAIN); ?></h3>
                </div>
                ...
                <div class="estp-twitter-content">
                <?php
            ...
            <div class="aptf-tweet-actions-wrapper aptf-tweet-actions">
                ...
                <a href="https://twitter.com/intent/retweet?tweet_id=<?php echo $tweet->id_str; ?>" class="aptf-tweet-retweet aptf-tweet-action-retweet" target="_blank"><i class="fa fa-retweet"></i>Retweet</a>
                <a href="https://twitter.com/intent/favorite?tweet_id=<?php echo $tweet->id_str; ?>" class="aptf-tweet-fav aptf-tweet-action-favourite" target="_blank"><i class="fa fa-star"></i>Favourite</a>
            </div>
        </div>
