<div class="estp-tab-wrapper estp-template-8 <?php echo $position_class; ?> <?php echo $display_position; ?> <?php echo 'estp-'.$estp_random_value; ?>">
<?php
	...
	>	
		...
		?>
			<div class="estp-popup-display" data-animation="<?php echo $animate_style; ?>">
				...
				<div class="estp-temp-8-close-btn" >
