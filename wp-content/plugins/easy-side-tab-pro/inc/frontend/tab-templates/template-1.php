<div class="estp-tab-wrapper estp-template-1 <?php echo $position_class; ?> <?php echo $display_position; ?> <?php echo 'estp-'.$estp_random_value; ?>">
...
<?php
	...
	{		
		...
		else if( ($pos_tab_settings_val['tab_content']['type'] == 'external'))
		{
			...
			if($scroll_type == 'custom_element') {
				$scroll_element_specific_page = (isset($pos_tab_settings_val['tab_content']['scroll_navigation']['scroll_nav_page']) && !empty($pos_tab_settings_val['tab_content']['scroll_navigation']['scroll_nav_page']))?explode(',', $pos_tab_settings_val['tab_content']['scroll_navigation']['scroll_nav_page']):array();
			}
		}
...
?>
	<!-- <div class="estp-inner-tab-wrapper" id="<?php //echo $tab_type == 'estp-scroll-navigation' ? 'estp-page-scroll-nav': ''; ?>"> -->
	...
	>	
		<div class="estp-tab-tooltip">
			<span class="estp-tab-tooltip-text" data-tooltip=""><?php echo esc_attr_e($pos_tab_settings_val['tooltip']); ?></span>
		</div>
		...
		?>
			<div class="estp-tab-element <?php echo $tab_type; ?>" data-tabtype="<?php echo $tab_type; ?>">
				<span><?php _e( ucwords($pos_tab_settings_val['tab_title']), ESTP_DOMAIN); ?></span>
			</div>
		<?php		
			}
		...
		<div class="estp-tab-element <?php echo $tab_type; ?>" data-tabtype="<?php echo $tab_type; ?>">
			...
			?>			
				<span>
					<?php _e($pos_tab_settings_val['tab_title']); ?>
				</span>
			<?php 
			}
			?>
			...
			?>
						<div class="estp-each-icon">
							<a href="<?php echo $value['link']; ?>">
								<!-- <img src="<?php //echo ESTP_IMAGE_DIR. '/icons-sets/'.$social_name.'.png'; ?>"> -->
								<?php 
