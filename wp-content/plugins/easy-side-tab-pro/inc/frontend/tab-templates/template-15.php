<div class="estp-tab-wrapper estp-template-15 <?php echo $position_class; ?> <?php echo $display_position; ?> <?php echo 'estp-'.$estp_random_value; ?>">
<?php
...
?>
	...
	?>
	>
		<?php /* <div class="estp-tab-tooltip">
			<span class="estp-tab-tooltip-text" data-tooltip=""><?php echo esc_attr_e($pos_tab_settings['tooltip']); ?></span>
		</div> */ ?>
		...
		?>
			<div class="estp-tab-element <?php echo $tab_type; ?>" data-tabtype="<?php echo $tab_type; ?>">
				...
				<span class="estp-tab-element-title"><?php _e( ucwords($pos_tab_settings['tab_title']), ESTP_DOMAIN); ?></span>
