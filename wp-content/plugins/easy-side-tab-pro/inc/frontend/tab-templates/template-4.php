<div class="estp-tab-wrapper estp-template-4 <?php echo $position_class; ?> <?php echo $display_position; ?> <?php echo 'estp-'.$estp_random_value; ?>">
<?php
...
?>
	...
	<?php  
		if($tab_type == 'estp-scroll-navigation') {
			...
			echo  'data-animation="'.$animate_style.'" ';
		}
	?>
	>	
