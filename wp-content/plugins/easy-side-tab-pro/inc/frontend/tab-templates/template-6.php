<div class="estp-tab-wrapper estp-template-6 <?php echo $position_class; ?> <?php echo $display_position; ?> <?php echo $animate_style; ?> <?php echo 'estp-'.$estp_random_value; ?>">
<?php
...
?>
	...
	?>
	<div class="estp-inner-tab-wrapper estp-tab-tooltip <?php echo ($tab_type == 'estp-scroll-navigation') ? 'estp-page-scroll-nav': $tab_type; ?>"
	<?php  
	...
	>
		...
		?>
			<div class="estp-tab-element <?php echo $tab_type; ?>" data-tabtype="<?php echo $tab_type; ?>">
				<span><i class="<?php echo str_replace('|', ' ', $icon_code); ?>"></i></span>
