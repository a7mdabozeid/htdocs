<div class="estp-tab-wrapper estp-template-2 <?php echo $position_class; ?> <?php echo $display_position; ?> <?php echo 'estp-'.$estp_random_value; ?>" >
<?php
	...
	{		
		...
		{
			if(isset($pos_tab_settings['tab_content']['content_slider']['content_type']) && ($pos_tab_settings['tab_content']['content_slider']['content_type'] == 'social_icons'))
			{
				$tab_type = 'estp-social-icons-wrapper';
			}
			else if(isset($pos_tab_settings['tab_content']['content_slider']['content_type']) && ($pos_tab_settings['tab_content']['content_slider']['content_type'] == 'twitter_feed'))
			{
				$tab_type = 'estp-twitter-feed-wrapper';
			}
			else if(isset($pos_tab_settings['tab_content']['content_slider']['content_type']) && ($pos_tab_settings['tab_content']['content_slider']['content_type'] == 'custom_shortcode'))
			{
				$tab_type = 'estp-custom-shortcode-wrapper';
			}
			else if(isset($pos_tab_settings['tab_content']['content_slider']['content_type']) && ($pos_tab_settings['tab_content']['content_slider']['content_type'] == 'subscription_form'))
			{
				$tab_type = 'estp-subscription-form-wrapper';
			}
			else if(isset($pos_tab_settings['tab_content']['content_slider']['content_type']) && ($pos_tab_settings['tab_content']['content_slider']['content_type'] == 'recent_blogs'))
			{
				$tab_type = 'estp-recent-blogs-wrapper';
			}
			else if(isset($pos_tab_settings['tab_content']['content_slider']['content_type']) && ($pos_tab_settings['tab_content']['content_slider']['content_type'] == 'woocommerce_product'))
			{
				$tab_type = 'estp-woocommerce-wrapper';
			}
			else if(isset($pos_tab_settings['tab_content']['content_slider']['content_type']) && ($pos_tab_settings['tab_content']['content_slider']['content_type'] == 'html_content'))
			{
...
?>	
	...
	>
		<div class="estp-tab-tooltip">
			<span class="estp-tab-tooltip-text" data-tooltip=""><?php _e($pos_tab_settings['tooltip']); ?></span>
		</div>
		...
		?>
			<div class="estp-popup-display" data-animation="<?php echo $animate_style; ?>">
