<div class="estp-recent-blog-single-wrap estp-blog-layout-3">
	...
	<div class="estp-recent-blog-feat-img">
		...
		<div class="estp-blog-title-date-author-wrap">
		 	...
		 	<div class="estp-blog-date-author">
		 		<div class="estp-blog-author">
					<small>by </small><?php the_author_posts_link(); ?>
				</div>
