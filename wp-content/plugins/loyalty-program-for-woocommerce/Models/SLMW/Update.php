...
class Update implements Model_Interface, Initiable_Interface, Deactivatable_Interface
{
    ...
    private function _fetch_software_product_update_data($activation_email, $license_key, $site_url)
    {
        ...
        ), apply_filters('lpfw_software_product_update_data_url', $this->_constants->UPDATE_DATA_URL));
    ...
    {
        if ($action == 'plugin_information' && isset($args->slug) && $args->slug == 'loyalty-program-for-woocommerce') {
    ...
    public function ajax_refetch_update_data()
    {
        ...
        } elseif (!isset($_POST['nonce']) || !wp_verify_nonce($_POST['nonce'], 'lpfw_slmw_refetch_update_data') || !current_user_can('manage_woocommerce')) {
