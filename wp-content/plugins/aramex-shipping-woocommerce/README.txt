...
With Aramex WooCommerce App, you can now tap into the most extensive delivery network in the Middle East, Asia, and Africa. With over 32 years in operations and 6 years of e-commerce fulfillment, Aramex can help you deliver your products to your customers wherever they are.


== Description ==

###Power up your e-store with the Aramex WooCommerce App!

With the Aramex WooCommerce App, you are directly integrated with Aramex’s back-end systems including our pickup system, delivery network, and our rate calculator. In a few easy steps, you can power up your site to start receiving orders throughout the world.
...
For a more detailed list of options and features of the plugin, please read the <a rel="nofollow" href="https://shopify-optilog.aramex.com/user_manual_woocommerce.pdf">User Manual</a>

[youtube https://www.youtube.com/watch?v=c_GJoZojR5A]
...
= 1. Currently I have not measured or weighed my products. Can I still get rates? =

It is mandatory to put in product weight while fetching the rates.

= 2. After the setup, my site is still saying “There doesn‘t seem to be any available shipping methods”. =

You should check if "Settings Allowed Domestic Methods" or "Allowed International Methods" are checked on Aramex Global Settings page.

== Screenshots ==

1. Aramex Global Settings page.
2. "Checkout" page.
3. "Prepare Aramex shipment" page.
4. "Calculate Rates" page.
5. "Schedule Pickup" page.
6. "Print Label" page.
7. "Track Aramex Shipment"page.
