...
Tags: refund woocommerce, cancel order, refund order, return, refund
...
Flexible Refund and Return Order for WooCommerce is a plugin that allows you to manage the refunds in WooCommerce. It will let your customers request a refund and return products directly from the My Account page. And to communicate with clients about their refund and return requests. Inform customers about privacy and refund policy in your store and manage returns and warranty requests efficiently.
...
* Automatic emails after the refund request status change,
...
You may help us [translate the plugin](https://translate.wordpress.org/projects/wp-plugins/flexible-refund-and-return-order-for-woocommerce).
...
= Can I use the WooCommerce Refund plugin for returns and product exchange? =

Yes. Flexible Refund can handle a lot of scenarios for order refunds, returns, product exchange, and warranty requests in your WooCommerce store! If you have more questions or suggestions about the plugin, contact us!
...
5. Placeholder and CSS class for a field of the WooCommerce refund form.
6. Refund Order from My Account in WooCommerce.
7. WooCommerce Order Refund requests directly from the My Account page.
8. Manage the Refund Request from the WooCommerce order edit screen.
9. Send emails about WooCommerce refunds, returns, and warranty requests automatically.
10. Use Flexible Refund emails.
11. Edit and customize the content of the Flexible Refund emails easily.
...
== Upgrade Notice ==
If you activate the PRO version, it will take over the functionality of the free version. So you won't need the free version to be installed
