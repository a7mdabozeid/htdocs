 ...
 */
class CreateCodeceptionTests extends \FRFreeVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    use SedTrait;
    /**
     * Configure command.
    ...
    {
        if (!\copy($source, $dest)) {
            throw new \FRFreeVendor\Composer\Downloader\FilesystemException($exceptionMessage);
        }
    }
    /**
