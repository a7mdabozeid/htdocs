...
namespace FRFreeVendor\WPDesk\Plugin\Flow;
...
{
    const LIBRARY_TEXT_DOMAIN = 'flexible-refund-and-return-order-for-woocommerce';
     ...
     */
    public function __construct($plugin_version, $plugin_release_timestamp, $plugin_name, $plugin_class_name, $plugin_text_domain, $plugin_dir, $plugin_file, array $requirements, $product_id, \FRFreeVendor\WPDesk\Plugin\Flow\Initialization\InitializationFactory $build_factory, $plugin_shops)
    {
     ...
     */
    private function init_translations(\FRFreeVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \FRFreeVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \FRFreeVendor\WPDesk_Plugin_Info();
