...
if (empty($notice_content)) {
    ?>
            <?php 
    \printf(\esc_html__('Hey %s,', 'flexible-refund-and-return-order-for-woocommerce'), $username);
    ?><br/>
            <?php 
    \esc_html_e('We need your help to improve <strong>WP Desk plugins</strong>, so they are more useful for you and the rest of <strong>30,000+ users</strong>. By collecting data on how you use our plugins, you will help us a lot. We will not collect any sensitive data, so you can feel safe.', 'flexible-refund-and-return-order-for-woocommerce');
    ?>
            <a href="<?php 
    echo \esc_url($terms_url);
    ?>" target="_blank"><?php 
    \esc_html_e('Find out more &raquo;', 'flexible-refund-and-return-order-for-woocommerce');
    ?></a>
        <?php 
} else {
    ?>
...
\esc_html_e('Allow', 'flexible-refund-and-return-order-for-woocommerce');
?></button>
    </p>
</div>
