...
class LoggerFacade
{
     ...
     * @return Logger
     */
    public static function getLogger($name = \FRFreeVendor\WPDesk\Logger\WPDeskLoggerFactory::DEFAULT_LOGGER_CHANNEL_NAME)
    {
        if (self::$factory === null) {
            self::$factory = new \FRFreeVendor\WPDesk\Logger\WPDeskLoggerFactory();
        }
     ...
     * @return Logger
     */
    public static function get_logger($name = \FRFreeVendor\WPDesk\Logger\WPDeskLoggerFactory::DEFAULT_LOGGER_CHANNEL_NAME)
    {
     ...
     * @param string $name Name of the logger
     */
    public static function set_disable_log($name = \FRFreeVendor\WPDesk\Logger\WPDeskLoggerFactory::DEFAULT_LOGGER_CHANNEL_NAME)
    {
