...
namespace FRFreeVendor\WPDesk\Logger\WC;

use FRFreeVendor\Monolog\Handler\AbstractProcessingHandler;
use FRFreeVendor\Monolog\Logger;
/**
 * Class WooCommerceFactory
 */
class WooCommerceHandler extends \FRFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return \FRFreeVendor\Monolog\Logger::getLevelName($level);
    }
