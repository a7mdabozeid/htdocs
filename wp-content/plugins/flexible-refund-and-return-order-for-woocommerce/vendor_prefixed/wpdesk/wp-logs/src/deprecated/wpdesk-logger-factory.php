...
if (!\class_exists('FRFreeVendor\\WPDesk_Logger_Factory')) {
    /**
    ...
    class WPDesk_Logger_Factory
    {
        ...
        public static function create_logger()
        {
            if (empty(self::$logger)) {
                $logger = new \FRFreeVendor\WPDesk_Logger();
                $logger->attach_hooks();
                self::$logger = $logger;
            }
            return self::$logger;
        ...
        public static function log_wp_error(\WP_Error $e, array $backtrace)
        {
            ...
            self::log_message_backtrace($message, \FRFreeVendor\WPDesk_Logger::ERROR, $backtrace);
        }
        /**
         * Log this exception into WPDesk logger
         *
        ...
        public static function log_exception(\Exception $e)
        {
            ...
            self::log_message($message, $e->getFile(), \FRFreeVendor\WPDesk_Logger::ERROR);
        }
        /**
         ...
         */
        public static function log_message($message, $source = 'unknown', $level = \FRFreeVendor\WPDesk_Logger::DEBUG)
        {
            self::create_logger();
         ...
         * @param array  $backtrace Backtrace information with snapshot of error env.
         */
        public static function log_message_backtrace($message, $level = \FRFreeVendor\WPDesk_Logger::DEBUG, array $backtrace)
        {
