 ...
 */
class PushoverHandler extends \FRFreeVendor\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct($token, $users, $title = null, $level = \FRFreeVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \FRFreeVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \FRFreeVendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \FRFreeVendor\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \FRFreeVendor\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
