 ...
 */
class SocketHandler extends \FRFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($connectionString, $level = \FRFreeVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
