 ...
 */
class SlackbotHandler extends \FRFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \FRFreeVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
