...
use FRFreeVendor\Monolog\Formatter\WildfireFormatter;
/**
 * Simple FirePHP Handler (http://www.firephp.org/), which uses the Wildfire protocol.
 *
 * @author Eric Clemmons (@ericclemmons) <eric@uxdriven.com>
 */
class FirePHPHandler extends \FRFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
    ...
    {
        return new \FRFreeVendor\Monolog\Formatter\WildfireFormatter();
    }
    /**
