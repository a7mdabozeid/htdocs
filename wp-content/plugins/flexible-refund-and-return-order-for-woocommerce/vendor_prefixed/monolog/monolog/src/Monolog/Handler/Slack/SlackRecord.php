 ...
 */
namespace FRFreeVendor\Monolog\Handler\Slack;
...
class SlackRecord
{
    ...
    public function __construct($channel = null, $username = null, $useAttachment = \true, $userIcon = null, $useShortAttachment = \false, $includeContextAndExtra = \false, array $excludeFields = array(), \FRFreeVendor\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \FRFreeVendor\Monolog\Formatter\NormalizerFormatter();
        }
    }
    ...
    {
        switch (\true) {
            case $level >= \FRFreeVendor\Monolog\Logger::ERROR:
                return self::COLOR_DANGER;
            case $level >= \FRFreeVendor\Monolog\Logger::WARNING:
                return self::COLOR_WARNING;
            case $level >= \FRFreeVendor\Monolog\Logger::INFO:
    ...
    public function stringify($fields)
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \FRFreeVendor\Monolog\Utils::jsonEncode($normalized, $prettyPrintFlag | $flags) : \FRFreeVendor\Monolog\Utils::jsonEncode($normalized, $flags);
    }
    /**
     * Sets the formatter
     *
