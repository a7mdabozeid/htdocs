 ...
 */
class RedisHandler extends \FRFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
    private $redisClient;
    private $redisKey;
    protected $capSize;
     ...
     */
    public function __construct($redis, $key, $level = \FRFreeVendor\Monolog\Logger::DEBUG, $bubble = \true, $capSize = \false)
    {
        if (!($redis instanceof \FRFreeVendor\Predis\Client || $redis instanceof \Redis)) {
