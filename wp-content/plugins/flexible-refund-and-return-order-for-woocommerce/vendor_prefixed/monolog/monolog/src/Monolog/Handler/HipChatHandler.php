 ...
 */
class HipChatHandler extends \FRFreeVendor\Monolog\Handler\SocketHandler
{
    /**
     * Use API version 1
     */
     ...
     */
    public function __construct($token, $room, $name = 'Monolog', $notify = \false, $level = \FRFreeVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $format = 'text', $host = 'api.hipchat.com', $version = self::API_V1)
    {
    ...
    protected function getAlertColor($level)
    {
        switch (\true) {
            ...
            case $level >= \FRFreeVendor\Monolog\Logger::INFO:
                return 'green';
            case $level == \FRFreeVendor\Monolog\Logger::DEBUG:
                return 'gray';
            default:
                return 'yellow';
        }
