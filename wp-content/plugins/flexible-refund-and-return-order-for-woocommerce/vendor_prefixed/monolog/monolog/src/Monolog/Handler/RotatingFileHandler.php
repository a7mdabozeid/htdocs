 ...
 */
class RotatingFileHandler extends \FRFreeVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \FRFreeVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \FRFreeVendor\Monolog\Utils::canonicalizePath($filename);
