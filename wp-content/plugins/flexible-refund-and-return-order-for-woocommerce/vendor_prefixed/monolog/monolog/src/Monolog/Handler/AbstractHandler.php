 ...
 */
abstract class AbstractHandler implements \FRFreeVendor\Monolog\Handler\HandlerInterface, \FRFreeVendor\Monolog\ResettableInterface
{
    protected $level = \FRFreeVendor\Monolog\Logger::DEBUG;
