 ...
 */
class BrowserConsoleHandler extends \FRFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \FRFreeVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
