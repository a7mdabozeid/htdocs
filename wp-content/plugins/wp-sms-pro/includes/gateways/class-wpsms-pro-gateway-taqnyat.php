...
class taqnyat extends \WP_SMS\Gateway
{
    private $wsdl_link = "https://api.taqnyat.sa/";
    public $tariff = "https://taqnyat.sa/";
    ...
    public function SendSMS()
    {
        ...
        $response = wp_remote_post($this->wsdl_link . 'v1/messages', [
            'headers' => [
    ...
    public function GetCredit()
    {
        ...
        $response = wp_remote_get($this->wsdl_link . '/account/balance', [
            'headers' => [
                'Authorization' => "Bearer $this->has_key",
            ],
        ]);
