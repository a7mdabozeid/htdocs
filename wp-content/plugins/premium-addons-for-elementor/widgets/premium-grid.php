				...
				<div class="pa-gallery-img <?php echo esc_attr( $skin ); ?>" onclick="">
					...
					if ( 'yes' === $image['premium_gallery_link_whole'] ) {
						...
						if ( 'url' === $image['premium_gallery_img_link_type'] && ! empty( $image['premium_gallery_img_link']['url'] ) ) {
							...
							?>
								<a class="pa-gallery-whole-link" href="<?php echo esc_attr( $icon_link ); ?>" <?php echo wp_kses_post( $external ); ?><?php echo wp_kses_post( $no_follow ); ?>>
								<?php if ( ! empty( $image['premium_gallery_img_name'] ) ) : ?>
									<span><?php echo wp_kses_post( $image['premium_gallery_img_name'] ); ?></span>
								<?php endif; ?>
								</a>
