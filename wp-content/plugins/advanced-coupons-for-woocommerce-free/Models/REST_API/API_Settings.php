...
class API_Settings implements Model_Interface
{
    ...
    public function get_settings_admin_permissions_check($request)
    {
        ...
        return apply_filters('acfw_get_settings_admin_permissions_check', $this->_helper_functions->check_if_valid_api_request($request));
    }
    ...
    {
        wc_deprecated_function('ACFWF\Models\REST_API\API_Settings::' . __FUNCTION__, '4.4.1', 'ACFWF\Helpers\Helper_Functions::check_if_valid_api_request');
        return $this->_helper_functions->check_if_valid_api_request($request);
    }
