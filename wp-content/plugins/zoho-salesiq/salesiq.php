...
<div class="lvd_sbdata">
        ...
        <ul>
            ...
            <li><span>Navigate to Settings > Brands , click on the name of the brand that you are attempting to include in a page.</span></li>
            <li><span>Select Installation.</span></li>
            <li><span>Choose Website in the Installation codes section.</span></li>
            <li><span>In the Installation section, click Copy this code to copy the code snippet and paste it here.</span></li>
