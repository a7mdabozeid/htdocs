class PaymentGetwayesModel {
  ...
  PaymentGetwayesModel({this.id, this.title, this.description, this.order, this.enabled, this.methodTitle, this.methodDescription, this.methodSupports, this.settings, this.needsSetup, this.postInstallScripts, this.settingsUrl, this.requiredSettingsKeys, this.links});
  ...
  PaymentGetwayesModel.fromJson(Map<String, dynamic> json) {
    ...
    methodSupports = json["method_supports"]==null ? null : List<String>.from(json["method_supports"]);
...
class Settings {
  ...
  Settings.fromJson(Map<String, dynamic> json) {
    ...
    descriptionType = json["description_type"] == null ? null : DescriptionType.fromJson(json["description_type"]);
  }
...
class DescriptionType {
  ...
  DescriptionType({this.id, this.label, this.description, this.type, this.value, this.defaultt, this.tip, this.placeholder, this.options});
