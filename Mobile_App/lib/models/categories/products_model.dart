...
class ProductModel {
  ...
  ProductModel({this.id,this.mainProductId , this.dateCreated,this.image,this.categoriesIds,this.categories,this.qty,this.name,this.images, this.dateCreatedGmt,this.type, this.dateModified, this.dateModifiedGmt, this.description, this.permalink, this.sku, this.price,this.fav, this.regularPrice, this.salePrice, this.onSale, this.status, this.purchasable, this.virtual, this.downloadable, this.downloads, this.downloadLimit, this.downloadExpiry, this.taxStatus, this.taxClass, this.manageStock, this.stockQuantity, this.stockStatus, this.backorders, this.backordersAllowed, this.backordered, this.weight, this.dimensions, this.shippingClass, this.shippingClassId, this.attributes, this.menuOrder, this.metaData, this.translations, this.lang, this.links});
...
class Attributes {
  ...
  Attributes({this.id, this.name,this.slug,this.visible, this.option,this.options});
  ...
  Attributes.fromJson(Map<String, dynamic> json) {
    ...
    selectedOptions = json['selectedOptions'] == null ? null : selectedOptions is String ? json['selectedOptions'] : List<String>.from(json["selectedOptions"]);
  }
...
class Images {
  ...
  Images({this.id, this.dateCreated, this.dateCreatedGmt, this.dateModified, this.dateModifiedGmt, this.src, this.name, this.alt});
