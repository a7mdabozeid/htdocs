...
class ForgotPass2 extends StatefulWidget {
  ...
  final String? type;
  const ForgotPass2({Key? key, required this.email,this.type}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              CustomText(text: "enterYourCode".tr(),fontSize: 20,fontWeight: FontWeight.w600,),
              const SizedBox(height: 20,),
              SizedBox(width: AppUtil.responsiveWidth(context)*0.65,child: CustomText(text: widget.type=="forgot"?"codeSentToEmail".tr():"codeSentToEmail2".tr(),color: AppUI.shimmerColor,textAlign: TextAlign.center,)),
              const SizedBox(height: 30,),
              CustomInput(controller: cubit.verifyController1,hint: "enterYourCode".tr(), textInputType: TextInputType.text),
              ...
              BlocBuilder<AuthCubit,AuthState>(
                  ...
                  builder: (context, state) {
                    ...
                    return Column(
                      children: [
                        CustomButton(text: "verify".tr(),onPressed: (){
                          cubit.verifyCode(context,widget.email,type: widget.type);
                        },),
                      ],
                    );
                  }
