                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          CustomInput(controller: cubit.password, hint: "rePass".tr(), textInputType: TextInputType.text,obscureText: cubit.passVisibility,suffixIcon: IconButton(onPressed: (){
                          ...
                          BlocBuilder<ProfileCubit,ProfileState>(
                              ...
                              return CustomButton(text: "saveChanges".tr(),onPressed: () async {
                                ...
                                AppUtil.successToast(context, "passwordChangedSuccessfully".tr());
                                }
                              },);
                            }
                          ),
