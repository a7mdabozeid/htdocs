...
class _SplashScreenState extends State<SplashScreen> {
  ...
  initState()  {
    ...
    Future.delayed(const Duration(milliseconds: 5500),()async{
      ...
      AppUtil.removeUntilNavigator(context, jwt==""?const LoginOrSignupScreen():const BottomNavTabsScreen());
    ...
    return Scaffold(
      body: Center(
        child: Stack(
          ...
          children: [
            Image.asset("${AppUI.imgPath}alshiaka_splash.gif",width: double.infinity,filterQuality: FilterQuality.high,),
